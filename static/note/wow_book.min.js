...
e;b++)this.insertPage(a[b],!0);this.updateBook(c)},insertPage:function(a,c){if(this.isPage(a))this.insertDoublePage(a,c);else{a=d(a).addClass("wowbook-page-content");var b=d("<div class='wowbook-page'></div>").css({width:this.pageWidth,height:this.pageHeight,display:"none",position:"absolute"}).appendTo(this.pagesContainer).append(a);d.wowBook.support.boxSizing&&a.css(d.wowBook.support.boxSizing,"border-box");p(a,this.pageWidth,this.pageHeight);b.hardPageSetByUser=a.hasClass("wowbook-hardpage");
